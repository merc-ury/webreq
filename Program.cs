...
/* NOTES
    ...
    * Need to re-write CartInfo.cs. Generated by Quicklytype.io.
*/
...
namespace webreq
{
    ...
    {
        // TEST URL
        static string baseURL = "https://www.jimmyjazz.com/products/nike-air-max-90-cd0881-101";
        ...
        static async Task Main(string[] args)
        {
            ...
            {
                if (await AddToCart(products[i].VariantId) == 200)
